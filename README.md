...
[![NPM](https://img.shields.io/badge/NPM-10.5.2-informational)](https://www.npmjs.com/)
[![YARN](https://img.shields.io/badge/YARN-4.3.0-informational)](https://yarnpkg.com/)
...
<div align='center'>
  <h1> Introduction to React Native with Hooks </h1>
</div>
...
When using Expo Go, ensure that both the mobile device and the PC are connected to the same Wi-Fi network.
