...
6. `Application/System Architectural Pattern`: Use an architectural pattern, such as [Hexagonal Architecture](https://github.com/camponogaraviera/full-stack-ai-sw-roadmap/blob/main/full_stack/architectural_patterns/hexagonal.md) or [Clean Architecture](https://github.com/camponogaraviera/full-stack-ai-sw-roadmap/blob/main/full_stack/architectural_patterns/clean.md).
